  ...
  return (
    <div className="app-page">
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-5">
        <section className="rounded-lg bg-[linear-gradient(110deg,#18181b,#193d38)] p-5 text-white shadow-none sm:p-7">
        ...
        <section className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-zinc-900/80 sm:p-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex gap-3">
              <span className="grid h-11 w-11 place-items-center rounded-lg bg-amber-100 text-amber-700 dark:bg-amber-400/10 dark:text-amber-100">
          ...
          {hasRecurring ? (
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              {data.recurringDonations.map((item) => (
                <div key={item.id} className="rounded-lg border border-zinc-200 p-3 dark:border-white/10">
          ...
          <div className="mt-5 space-y-3">
            {data.donations.length ? (
              data.donations.map((donation) => {
                ...
                return (
                <article key={donation.id} className="rounded-lg border border-zinc-200 p-4 dark:border-white/10">
